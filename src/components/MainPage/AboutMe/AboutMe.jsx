    ...
    <section className="about-me">
      ...
      <div className="about-me__info">
        <div className="about-me__text">
          ...
          Решил сменить профессию, так как хотел больше умственной работы и возможность работать из любой точки мира. 
          Программирование заинтересовало меня еще в школе, а во время обучения на курсе увлекло. Мне нравится возможность 
          создавать что-то новое и видеть результат своей работы. До программирования 4 года работал в барной индустрии, 
          вырос до шеф-бармена. Увлекаюсь скейтбордингом, кинематографом и барной культурой.
          </p>
